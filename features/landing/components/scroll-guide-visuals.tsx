...
export function StepThreeVisual() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
      ...
      <g className="step3-card1">
        <rect x="50" y="130" width="120" height="180" rx="10" fill="var(--color-paper)" stroke="var(--color-rule)" strokeWidth="1" />
        <rect x="65" y="150" width="32" height="32" rx="16" fill="var(--color-workspace-soft)" />
        <rect x="65" y="195" width="80" height="10" rx="5" fill="var(--color-ink-soft)" />
        <rect x="65" y="215" width="60" height="8" rx="4" fill="var(--color-ink-faint)" />
        <rect x="65" y="235" width="70" height="8" rx="4" fill="var(--color-ink-faint)" />
        <rect x="65" y="255" width="40" height="8" rx="4" fill="var(--color-ink-faint)" />
      </g>
      <g className="step3-card2">
        <rect x="190" y="130" width="120" height="180" rx="10" fill="var(--color-paper-raised)" stroke="var(--color-accent)" strokeWidth="2" />
        <rect x="190" y="130" width="120" height="180" rx="10" fill="var(--color-accent-soft)" opacity="0.28" filter="blur(20px)" className="step3-glow2" />
        <rect x="205" y="150" width="32" height="32" rx="16" fill="var(--color-accent-soft)" />
        <path d="M213 166l5 5 9-9" stroke="var(--color-accent-dark)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
        <rect x="205" y="195" width="80" height="10" rx="5" fill="var(--color-ink)" />
        <rect x="205" y="215" width="60" height="8" rx="4" fill="var(--color-ink-soft)" />
        <rect x="205" y="235" width="70" height="8" rx="4" fill="var(--color-ink-soft)" />
        <rect x="205" y="255" width="40" height="8" rx="4" fill="var(--color-ink-soft)" />
      </g>
      <g className="step3-card3">
        <rect x="330" y="130" width="120" height="180" rx="10" fill="var(--color-paper)" stroke="var(--color-rule)" strokeWidth="1" />
        <rect x="345" y="150" width="32" height="32" rx="16" fill="var(--color-workspace-soft)" />
        <rect x="345" y="195" width="80" height="10" rx="5" fill="var(--color-ink-soft)" />
        <rect x="345" y="215" width="60" height="8" rx="4" fill="var(--color-ink-faint)" />
        <rect x="345" y="235" width="70" height="8" rx="4" fill="var(--color-ink-faint)" />
        <rect x="345" y="255" width="40" height="8" rx="4" fill="var(--color-ink-faint)" />
      </g>
    </svg>
  );
}
